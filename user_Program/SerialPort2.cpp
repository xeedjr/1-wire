...
//
int MSerial2::OpenCOMEx(char *port_zstr)
{
   int portnum;
...
//
SMALLINT MSerial2::OpenCOM(int portnum, char *port_zstr)
{
   char tempstr[80];
   short fRetVal;
...
//
void MSerial2::CloseCOM(int portnum)
{
...
//              OpenCOM to indicate the port number.
//
void MSerial2::FlushCOM(int portnum)
{
   // purge any information in the buffer
   PurgeComm(ComID[portnum], PURGE_TXABORT | PURGE_RXABORT |
                    PURGE_TXCLEAR | PURGE_RXCLEAR );
...
//           FALSE(0) - failure
//
SMALLINT MSerial2::WriteCOM(int portnum, int outlen, uchar *outbuf)
{
   BOOL fWriteStat;
...
//
int MSerial2::ReadCOM(int portnum, int inlen, uchar *inbuf)
{
   DWORD dwLength=0;
   BOOL fReadStat;
   DWORD ler=0,to;
...
//              OpenCOM to indicate the port number.
//
void MSerial2::BreakCOM(int portnum)
{
...
//                PARMSET_115200   0x06
//
void MSerial2::SetBaudCOM(int portnum, uchar new_baud)
{
   DCB dcb;
